...
public class GetTrxnDetail {
	...
	private static String server = "https://ebctest.cybersource.com/ebctest/Query"; // for Production system, use https://ebc.cybersource.com/ebc/Query
	private static String merchantID = "gptw15877002600";
	private static String username = "77002600_admin";
	private static String passwd = "Dsqw12321";
